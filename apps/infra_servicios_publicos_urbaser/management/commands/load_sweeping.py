...
MACROROUTES_DEF = {
    'B211': {
        'name':          'Comunas 1,2,3,8,9 — Lu-Ju 06:00-14:00',
        'zone_type':     'residential',
        'communes_text': '1,2,3,8,9',
        'days_text':     'Lu-Ju',
        'schedule_text': '6:00-14:00',
        'start_time':    time(6, 0),
        'end_time':      time(14, 0),
    },
    'B212': {
        'name':          'Comunas 2,4,5,7,8,9 — Ma-Vi 06:00-14:00',
        'zone_type':     'residential',
    ...
    'B213': {
        'name':          'Comunas 3,4,5,6,7 — Mi-Sá 06:00-14:00',
        'zone_type':     'residential',
    ...
    '611': {
        'name':          'Vías principales + Centro + Mercados — Lu-Sá 05:00-13:00',
        'zone_type':     'main_roads',
        'communes_text': '1,2,3,4,5,6,7,8,9',
        'days_text':     'Lu-Sá',
        'schedule_text': '5:00-13:00',
        'start_time':    time(5, 0),
        'end_time':      time(13, 0),
    },
    '621': {
        'name':          'Centro histórico tarde — Lu-Sá 13:00-21:00',
        'zone_type':     'historic_center',
        'communes_text': '4',
        'days_text':     'Lu-Sá',
        'schedule_text': '13:00-21:00',
        'start_time':    time(13, 0),
        'end_time':      time(21, 0),
    },
    '631b': {
        'name':          'Centro histórico nocturno — Lu-Sá 19:00-03:00',
        'zone_type':     'historic_center',
        'communes_text': '4',
        'days_text':     'Lu-Sá',
        'schedule_text': '19:00-03:00',
        'start_time':    time(19, 0),
        'end_time':      time(3, 0),  # cruza medianoche
    },
    '117b': {
        'name':          'Centro histórico — Domingo 09:00-13:30',
        'zone_type':     'sunday',
        'communes_text': '4',
        'days_text':     'Domingo',
        'schedule_text': '9:00-13:30',
        'start_time':    time(9, 0),
        'end_time':      time(13, 30),
    },
    '127b': {
        'name':          'Plazas de mercado — Domingo 10:00-14:30',
        'zone_type':     'market',
        'communes_text': '4',
        'days_text':     'Domingo',
        'schedule_text': '10:00-14:30',
